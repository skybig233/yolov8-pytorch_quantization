...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / "../ultralytics/yolov8n-obb.pt", help='model.pt path(s)')
    parser.add_argument('--model-name', '-m', default='yolov8n-obb-dota', help='model name: default yolov5s')
    ...
    parser.add_argument('--calibrator', type=str, choices=["max", "histogram"], default="histogram")
...
if __name__ == "__main__":
    ...
    desc="yolov8n_obb_max_channel_dota"
    # result_dir=os.path.join(opt.out_dir,desc)
    onnx_filename = desc+'.onnx'
